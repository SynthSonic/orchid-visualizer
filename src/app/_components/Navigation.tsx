...
const Navigation = memo(() => {
  ...
  return (
    <>
      <nav className="mx-auto inline-flex justify-center rounded-b-[32px] bg-[#222] p-[20px_24px]">
